...
process_input_data <- function(data, id_col_name, keytype="Ensembl", mean_expr_col_name=NULL, pval_col_name=NULL){
...
run_gsea <- function(data, gene_sets, id_col_name, sorting_value_col_name){
  data <- data[order(data[[sorting_value_col_name]], decreasing = TRUE), ]
  ranked_gene_list <- setNames(data[[sorting_value_col_name]], data[[id_col_name]])
...
prepare_data <- function(data, id_col_name, keytype="Ensembl", mean_expr_col_name=NULL, pval_col_name=NULL){
...
gsea_analysis <- function(data, gene_sets, id_col_name, sorting_value_col_name, name="data")
{
  #processed_data <- process_data(results_list, id_col_name)
  
  gsea_results <- run_gsea(data, gene_sets, id_col_name, sorting_value_col_name)
